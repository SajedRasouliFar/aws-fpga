...
#$XILINX_SDX/runtime/bin/xclbinsplit -o ${kernel} _xocc_link_krnl_${kernel}.sw_emu.xilinx_minotaur-vu9p-f1_4ddr-xpr_3_3_krnl_${kernel}.sw_emu.xilinx_minotaur-vu9p-f1_4ddr-xpr_3_3.dir/impl/build/cpu_em/krnl_${kernel}.sw_emu.xilinx_minotaur-vu9p-f1_4ddr-xpr_3_3/csim/krnl_${kernel}.sw_emu.xilinx_minotaur-vu9p-f1_4ddr-xpr_3_3.xcp
